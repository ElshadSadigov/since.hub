    ...
    return (
        <div className='flex flex-col items-center bg-[#374af3] relative'>
            <div className='my-[60px] flex flex-col items-center w-full'>
                ...
                <p className='text-[16px] text-[#fff]'>Lazım olan məlumatı tez tapmaq və ya sizi maraqlandıran mövzuları araşdırmaq üçün axtarış edin.</p>
                <div className='mt-[30px] flex items-center justify-between w-[50%] bg-[#fff] ps-[24px] py-[6px] pe-[7px] rounded-[8px]'>
            ...
            <div className='w-[90%] flex justify-center py-[13px] bg-[#fff] bg-opacity-15 rounded-t-[24px] border-[1px] border-[#fff] border-opacity-50'>
                <span className='text-[16px] font-semibold text-[#fff]'>Araşdırın, kəşf edin və öyrənin. Axtardığınız hər şey buradadır!</span>
            </div>
            {/* Line */}
