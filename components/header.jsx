...
const Header = () => {
  ...
  const [language, setLanguge] = useState(false)
    ...
    <div>
      <div className='w-full max-w-[1550px] fixed z-[999] left-[50%] top-0 translate-x-[-50%]'>
        ...
        <div>
          <div className='xl:px-[80px] lg:px-[50px] md:px-[30px] px-[16px] py-[20px] flex justify-between items-center w-full bg-[#374AF3]'>
            <button onClick={() => setOpenDropdown(!openDropdown)} className='md:hidden block'>
              <Image src={menu} alt='menu' />
            </button>
            <Link href='/' className='flex items-start'>
              <span className='lg:text-[36px] md:text-[32px] text-[22px] font-bold text-[#050123]'>SİNCE</span>
              <span className='lg:text-[36px] md:text-[32px] text-[22px] font-bold text-[#fff]'>.HUB</span>
            ...
            <div className='flex items-center lg:gap-[30px] md:gap-[10px] gap-[15px]'>
              <div className='cursor-pointer relative md:block hidden'>
                ...
                {searchOpen ?
                  <div className='absolute left-[-120px] top-[38px] z-10 bg-[#fff] flex items-center justify-between lg:w-[350px] md:w-[280px] p-[5px] rounded-lg  shadow-md'>
                    <input type="text" placeholder='Axtar...' className='ps-[12px] outline-none py-[5px]' />
                    <button>
              ...
              <div className='flex items-center gap-[7px] cursor-pointer relative'>
                <div onClick={() => setLanguge(!language)} className='flex items-center gap-[7px]'>
          ...
          <div className='md:hidden flex px-[16px] py-[20px] bg-[#fff] border-b-[1px] border-[d5d4dc]'>
            <div className='flex items-center justify-between w-full p-[5px] rounded-lg border-[1px] border-[#050123] border-opacity-15 bg-[#fff]'>
              <input type="text" placeholder='Axtar...' className='outline-none ps-[12px] py-[5px] w-full' />
              <button>
                <Image src={searchIcon2} alt='search icon' />
              </button>
            </div>
      ...
      <div className={openDropdown
        ...
        <div className='relative flex items-center justify-center py-[20px] border-b-[2px] border-[#050123] border-opacity-10'>
          ...
          <button onClick={() => setOpenDropdown(!openDropdown)} className='absolute top-[20px] right-[20px]'>
            <Image src={closeIcon} alt='close icon' />
          </button>
        </div>
        <ul>
          <li onClick={()=>setOpenDropdown(!openDropdown)} className='text-[16px] font-medium text-[#050123] px-[12px] py-[8px] border-b-[1px] border-[#050123] border-opacity-5 hover:bg-[#374af3] hover:bg-opacity-10'><Link href='/about'>Haqqımızda</Link></li>
          <li onClick={()=>setOpenDropdown(!openDropdown)} className='text-[16px] font-medium text-[#050123] px-[12px] py-[8px] border-b-[1px] border-[#050123] border-opacity-5 hover:bg-[#374af3] hover:bg-opacity-10'><Link href='/rules'>Qaydalar</Link></li>
          <li onClick={() => setServices(!services)} className='text-[16px] font-medium text-[#050123] px-[12px] py-[8px] border-b-[1px] border-[#050123] border-opacity-5 '>
            ...
            </div>
            {
              services ?
                <ul>
                  <li onClick={()=>setOpenDropdown(!openDropdown)} className='text-[16px] font-medium text-[#050123] px-[12px] py-[8px] border-b-[1px] border-[#050123] border-opacity-5 hover:bg-[#374af3] hover:bg-opacity-10'><Link href='/blogs'>Bloqlar</Link></li>
                  <li onClick={()=>setOpenDropdown(!openDropdown)} className='text-[16px] font-medium text-[#050123] px-[12px] py-[8px] border-b-[1px] border-[#050123] border-opacity-5 hover:bg-[#374af3] hover:bg-opacity-10'><Link href='/books'>Kitablar</Link></li>
                  <li onClick={()=>setOpenDropdown(!openDropdown)} className='text-[16px] font-medium text-[#050123] px-[12px] py-[8px] border-b-[1px] border-[#050123] border-opacity-5 hover:bg-[#374af3] hover:bg-opacity-10'><Link href='/articles'>Məqalələr</Link></li>
                  <li onClick={()=>setOpenDropdown(!openDropdown)} className='text-[16px] font-medium text-[#050123] px-[12px] py-[8px] border-b-[1px] border-[#050123] border-opacity-5 hover:bg-[#374af3] hover:bg-opacity-10'><Link href='/dissertations'>Disertasiyalar</Link></li>
                  <li onClick={()=>setOpenDropdown(!openDropdown)} className='text-[16px] font-medium text-[#050123] px-[12px] py-[8px] border-b-[1px] border-[#050123] border-opacity-5 hover:bg-[#374af3] hover:bg-opacity-10'><Link href='/question-and-answer'>Sual cavab</Link></li>
          ...
          <li onClick={()=>setOpenDropdown(!openDropdown)} className='text-[16px] font-medium text-[#050123] px-[12px] py-[8px] border-b-[1px] border-[#050123] border-opacity-5 hover:bg-[#374af3] hover:bg-opacity-10'><Link href='/contact'>Əlaqə</Link></li>
        </ul>
      </div>
    </div>
  )
