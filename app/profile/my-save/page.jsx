  ...
  return (
    <div className='px-[80px]'>
      <div className='flex flex-col gap-[20px] pb-[20px] border-b-[1px] border-[#050123] border-opacity-15'>
        <span className='text-[24px] font-medium text-[#050123]'>Yadda saxlanılanlar</span>
        <p className='text-[16px] text-[#050123]'>Yadda saxlanılanları profilinizdə istədiyiniz kimi idarə edin.</p>
      </div>
