...
const page = () => {
  return (
    <div>
      ...
      <div className='mt-[40px] md:mt-[80px] mb-[120px] px-[30px] md:px-[80px]'>
        ...
        <div className='mt-[65px] grid grid-cols-1 md:grid md:grid-cols-2 gap-[70px] md:gap-[140px]'>
          ...
          <div className=''>
            <iframe className='w-[366px] h-[376px] md:w-full md:h-full rounded-[12px]' src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3039.541156296084!2d49.84938087582501!3d40.37469737144642!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x40307da97b6f60f3%3A0x559b0d76c5587ad8!2zODAgw5x6ZXlpciBIYWPEsWLJmXlvdiwgQmFrxLE!5e0!3m2!1saz!2saz!4v1711039065732!5m2!1saz!2saz"  allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
          </div>
        </div>
      </div>
    </div>
